...
class changermdp extends StatefulWidget {
  int id ;
  String password ;
  changermdp({ Key key , this.id , this.password }) : super(key: key);
...
Future<String> changermdp() async {
    ...
    http.Response response = await http.post(
        "http://192.168.43.4:8080/suivimedical/controller/medecin_controllers/changermdp.php",
        body: {
          "idmed" : widget.id.toString() ,
                ...
                Container(
                  ...
                  child: TextFormField(
                     validator: (value1) {
                          ...
                          else if (value1 != widget.password){
